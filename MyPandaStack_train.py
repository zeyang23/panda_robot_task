...
env = gym.make('My_PandaStackDense-v1')

log_dir = './tensorboard/my_panda_stack_dense_v1/'

total_timesteps = 10000000

checkpoint_callback = CheckpointCallback(save_freq=100000, save_path='model_checkpoints/my_stack',
                                         name_prefix='my_stack')
...
model.save("./trained/my_panda_stack_dense_v1/my_panda_stack_dense_v1_tqc")
