...
log_dir = './tensorboard/my_two_panda_pick_and_place_dense_v1/'
...
# model.save("./trained/my_panda_pick_and_place_v1/my_panda_pick_and_place_v1_sac")
...
model.save("./trained/my_two_panda_pick_and_place_v1/my_two_panda_pick_and_place_v1_sac")
