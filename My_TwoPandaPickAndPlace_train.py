...
checkpoint_callback = CheckpointCallback(save_freq=100000, save_path='model_checkpoints/two_pick_and_place',
...
model.save("./trained/two_pick_and_place_dense_v1/two_pick_and_place_dense_v1_sac")
