...
env = gym.make('My_PandaReach-v1')

log_dir = './tensorboard/my_panda_reach_v1/'
...
# SAC
model = SAC(policy="MultiInputPolicy", env=env, buffer_size=100000, verbose=1, replay_buffer_class=HerReplayBuffer,
            tensorboard_log=log_dir)
model.learn(total_timesteps=total_timesteps)
model.save("./trained/my_panda_reach_v1/my_panda_reach_v1_sac")
